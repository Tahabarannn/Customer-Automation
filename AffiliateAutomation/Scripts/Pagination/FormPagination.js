...
$(function () {
    var numberOfItems = $(".emailList__list .emailRow").length;
    var limitPerPage = 7; //How many items visible per page
    ...
    function showPage(whichPage) {
        ...
        $(".emailList__list .emailRow").hide().slice((currentPage - 1) * limitPerPage, currentPage * limitPerPage).show();
