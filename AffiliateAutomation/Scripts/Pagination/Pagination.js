...
$(function () {
    var numberOfItems = $(".item-content .aff-item").length;
    var limitPerPage = 10; //How many items visible per page
    ...
    function showPage(whichPage) {
        ...
        $(".item-content .aff-item").hide().slice((currentPage - 1) * limitPerPage, currentPage * limitPerPage).show();
