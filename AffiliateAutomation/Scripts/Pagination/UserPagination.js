...
$(function () {
    var numberOfItems = $(".card_item .card_inner").length;
    var limitPerPage = 4; //How many items visible per page
    ...
    function showPage(whichPage) {
        ...
        $(".card_item .card_inner").hide().slice((currentPage - 1) * limitPerPage, currentPage * limitPerPage).show();
